...
return [
    ...
    'filename' => 'C:/xampp/htdocs/cms_grav/user/plugins/grav-plugin-simple-cookie-master/blueprints.yaml',
    'modified' => 1599238437,
    'data' => [
        'name' => 'Simple Cookie',
        'version' => '0.1.8',
        ...
        'form' => [
            ...
            'fields' => [
                ...
                'banner_policytarget' => [
                    'type' => 'select',
                    'label' => 'Policy link target',
                    'help' => 'target in which the link is to open',
                    'default' => '_blank',
                    'options' => [
                        '_blank' => 'new tab',
                        '_self' => 'current tab',
